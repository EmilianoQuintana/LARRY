...
public class Time
{
    ...
    public Time(String format, String value)
    {
        ...
        {
            // Format: 01:02:22,501 (used in .SRT)
            int h, m, s, ms;
        ...
        } else if (format.equalsIgnoreCase(Const.TIME_FORMAT_SSA))
        {
            // Format: 1:02:22.51 (used in .ASS/.SSA)
            int h, m, s, cs;
        ...
        } else if (format.equalsIgnoreCase(Const.TIME_FORMAT_STL))
        {
            int h, m, s, f;
            float fps;
    ...
    protected String getTime(String format)
    {
        ...
        } else if (format.startsWith("h:m:s:f/"))
        {
            ...
            //if (aux.length()==1) time.append('0');
            time.append(aux);
        } else if (format.startsWith(Const.TIME_FORMAT_SCC))
        {
    ...
    /**
     * this type of format:  01:02:22.501 (used in SQL)
     */
    public String toSQLTime3()
    {
